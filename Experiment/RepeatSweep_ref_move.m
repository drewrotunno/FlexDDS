...
clear all;
% Need one trigger to set up phase lock,
% then subsequent pairs of triggers sweep up and back
% repeatedly. 
...
stack2 = waitforRackA(stack2, 0); stack2 = rampup(stack2, 0);
stack2 = waitforRackA(stack2, 0); stack2 = rampdown(stack2, 0);
r=r+1;
end
