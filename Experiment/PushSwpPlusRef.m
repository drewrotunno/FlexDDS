...
endFreq         =  8.389e6;     % in Hz, one you want
startFreq       =  4.4e6;       % where you sweep from. > w_0/2 preferred
refFreq         =100.000e6;     % mixer reference freq, in Hz
phasediff       =  15;         % degrees chan A will be ahead of B


sweepTime = 0.1e-3;     % seconds
